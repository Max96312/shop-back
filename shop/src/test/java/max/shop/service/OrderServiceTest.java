...
//        MemberRegisterForm userForm = MemberRegisterForm.of("testId", "testName", "qwer1234!", "010-1234-1234", LocalDateTime.now(), Gender.MALE);
//        Member user = Member.createUser(userForm);
